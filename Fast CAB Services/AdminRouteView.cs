...
{
    public partial class Form_AdminRouteView : Form
    {
        ...
        private void dataGridView_RouteView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void Form_AdminRouteView_Load(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter("select * from tbl_Route", con);
                adp.Fill(dt);
                dataGridView_RouteView.DataSource = dt;
            }
            catch (Exception)
            {
