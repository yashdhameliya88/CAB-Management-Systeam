...
{
    public partial class Form_AdminManagerView : Form
    {
        ...
        private void Form_AdminManagerView_Load(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter("select * from tbl_Manager_Registation", con);
                adp.Fill(dt);
                dataGridView_ManagerView.DataSource = dt;
