...
{
    public partial class Form_AdminVehicleView : Form
    {
        ...
        private void Form_AdminVehicleView_Load(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter("select * from tbl_Vehicle", con);
                adp.Fill(dt);
                dataGridView_VehicleView.DataSource = dt;
            }
            catch (Exception)
            {
