...
{
    public partial class Form_AdminManagerUpdate1 : Form
    {
        ...
        public Form_AdminManagerUpdate1()
        {
            InitializeComponent();
        }
        ...
        private void Form_AdminManagerUpdate1_Load(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = new DataTable();
                SqlDataAdapter adp = new SqlDataAdapter("select * from tbl_Allocation", con);
                adp.Fill(dt);
                dataGridView_Allocation.DataSource = dt;
