...
{    
    public partial class Form_AdminRouteAdd : Form
    {
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlDataAdapter adp = new SqlDataAdapter("insert into tbl_Route values('"+txt_RouteID.Text+"','"+txt_Source.Text+"','"+txt_Destination.Text+"','"+txt_RouteDescription.Text+"','"+txt_Distance.Text+"')", con);
                adp.SelectCommand.ExecuteNonQuery();
                con.Close();
                MessageBox.Show("Route Data Insert SuccessFully...");

                txt_RouteID.Text = "";
                txt_Source.Text = "";
                txt_Destination.Text = "";
                txt_RouteDescription.Text = "";
                txt_Distance.Text = "";
            }
            catch (Exception)
            {
